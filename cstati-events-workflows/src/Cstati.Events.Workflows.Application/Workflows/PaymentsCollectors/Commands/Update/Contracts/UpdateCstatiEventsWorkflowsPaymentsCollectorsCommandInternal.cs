...
namespace Cstati.Events.Workflows.Application.Workflows.PaymentsCollectors.Commands.Update.Contracts;

public sealed class UpdateCstatiEventsWorkflowsPaymentsCollectorsCommandInternal : IRequest
{
    public UpdateCstatiEventsWorkflowsPaymentsCollectorsCommandInternal(
        string eventId,
        string personLogin,
